...
using FloraLimitedTest.Modules.Cookie;
using FloraLimitedTest.Modules.Mail;
using FloraLimitedTest.Modules.Session;
using FloraLimitedTest.Modules.TimeZone;
...
namespace FloraLimitedTest {
    ...
    public struct AppVar {
        ...
        //public const string DefaultConnection = @"Data Source=(LocalDb)\v11.0;AttachDbFilename=|DataDirectory|\FloraLimitedTest-Accounts.mdf;Initial Catalog=FloraLimitedTest-Accounts;Integrated Security=True";
