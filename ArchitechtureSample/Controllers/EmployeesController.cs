...
{
    public class EmployeesController : GenericController<TestDatabaseEntities> {
		...
		const string EditedError = "Sorry for the inconvenience, last transaction is failed to save into the database. Please be in touch with admin.";
		...
		public void GetDropDowns(Employee employee = null){
			if(employee != null){
				ViewBag.CategoryID = new SelectList(db.Categories.ToList(), "CategoryID", "CategoryName", employee.CategoryID);
			} else {			
        ...
        public ActionResult Index() { 
            ...
            var employees = db.Employees.Include(e => e.Category);
        ...
        public ActionResult Index(System.Int32 id) {
            var employees = db.Employees.Include(e => e.Category).Where(n=> n. == id);
			bool viewOf = ViewTapping(ViewStates.Index);
            return View(employees.ToList());
        }
		*/
